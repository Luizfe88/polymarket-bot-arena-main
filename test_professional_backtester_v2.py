...
def test_enhanced_backtester():
    ...
    # Create backtest configuration with more lenient parameters
    config = BacktestConfig(
        mode=BacktestMode.WALK_FORWARD,
        train_window_days=30,
        test_window_days=7,
        step_days=7,  # Weekly steps for more windows
        min_trades=3,   # Lower threshold for testing
    ...
    # Create a custom backtester that uses our bot
