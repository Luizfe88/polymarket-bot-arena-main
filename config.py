...
MIN_MARKET_VOLUME = _env_int("MIN_MARKET_VOLUME", 30000)
MAX_MARKET_SPREAD = _env_float("MAX_MARKET_SPREAD", 1.0)
MIN_TIME_TO_RESOLUTION = _env_int("MIN_TIME_TO_RESOLUTION", 4)
MAX_TIME_TO_RESOLUTION = _env_int("MAX_TIME_TO_RESOLUTION", 2160)

PRIORITY_CATEGORIES = []
MIN_EV_THRESHOLD = _env_float("MIN_EV_THRESHOLD", 0.0)
