...
def debug_market_discovery():
    """Debug detalhado do market discovery"""
    all_markets = []
    
    try:
        logging.info("=== DEBUG MARKET DISCOVERY v3.0 ===")
        logging.info("Fetching markets for detailed analysis...")
        
        # Buscar apenas 50 mercados para debug
        ...
        logging.info(f"Fetched {len(markets)} markets for analysis")
        ...
        logging.info(f"\n=== RESUMO ===")
        logging.info(f"Total de mercados analisados: {len(markets)}")
